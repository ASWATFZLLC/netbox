...
DATABASE = {
    'NAME': os.environ.get('POSTGRESQL_ADDON_DB', 'madrasa'),
    'USER': os.environ.get('POSTGRESQL_ADDON_USER', 'madrasa'),
    'PASSWORD': os.environ.get('POSTGRESQL_ADDON_PASSWORD', 'madrasa'),
